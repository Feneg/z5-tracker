...
ITEMS = (
    ...
    i('Bottle with Letter', (1, 3), ("Ruto's Letter",),
       ('bottle_letter',), link=(('Deliver Letter', 1),)),
    ...
    i('Carpenter Rescue', (4, 5), ('Rescued Carpenters',), ('saw',)),
    ...
    i('Bottle', (0, 7), ('Bottles',)*4, tuple(zip(('bottle',)*4, range(1, 5)))),
    i('Scarecrow Song', (5, 7), ('Scarecrow',), ('scarecrow',)),
